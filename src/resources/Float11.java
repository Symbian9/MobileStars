...
/*
 * Taken directly from: http://discussion.forum.nokia.com/forum/showthread.php?t=72840
 * renamed from mMath.java -> Float11.java
 * Created on 14 January 2006, 20:00
 *
 * (c) 2006 Richard Carless (xedarius)
 * 
 * ================================================
 * Re: Maths - acos, asin, atan - 2006-08-19, 19:21
 * Hi Mats,
 * Sorry for the slow reply I've been on holiday.
 * Feel free to change and chop the code as you see fit.
 * Oh and Richard Carless is my real name :)
 * ================================================ 
 */
...
public class Float11
{
    ...
    /**
     * Taken directly from: http://calum.org/posts/j2me-functions-that-arent-included-but-should-be
     * @param arg
     * @param times
     * @return
     */
